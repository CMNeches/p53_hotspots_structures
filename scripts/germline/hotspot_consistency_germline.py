...
plt.savefig("../../results/hotspots/germline/tissue_hotspot_consistency.png", bbox_inches="tight")

tissue_df.to_csv("../../results/hotspots/germline/tissue_hotspots.tsv", sep="\t", index=False)
