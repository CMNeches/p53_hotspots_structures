...
df["Tissue"] = tissues
df.to_csv("../../results/heatmaps/chi_square_domain_tissue_statistics_somatic.tsv", sep="\t", index = False)
...
plt.legend()
plt.savefig("../../results/heatmaps/chi_square_domain_tissue_statitics_somatic.png", bbox_inches="tight")
plt.show()
